...
class FormButtons implements FormButtonsInterface
{
    ...
    protected $importButtonText;
    
    protected  $resetButtonText;
    
    protected $upButtonText;
...
//    protected $request = \Illuminate\Http\Request;
    ...
    public function getResetButtonText(){
        if(is_null($this->resetButtonText)){
            $this->resetButtonText = 'изменить';
        }
        
        return $this;
    }
    
    public function showUpButton(){
       $this->showUpButton = true;
       return $this;
    }
    
    public function setUpButtonText($ipButtonText){
        $this->upButtonText = $upButtonText;
        return $this;
    }
    
    public function getUpButtonText(){
        if (is_null($this->upButtonText)){
            $this->upButtonText = 'перевести на один класс выше';
        }
        return $this;
    }
    ...
    public function  isShowResetButton( ){
    ...
    public function setImportButtonText($importButtonText){
        $this->importButtonText = $importButtonText;
        return $this;
    }
    
    public function getImportButtonText(){
        if (is_null($this->importButtonText)){
            $this->importButtonText = 'импорт из файла xml';
        }
        return $this;
    }
    ...
    public function isShowImportButton(){
        return $this->showImportButton;
    }
    
    public function hideImportButton(){
    ...
    public function toArray()
    {
        return [
            ...
            'resetUrl'                => '/admin/users/'.$this->getModel()->getKey().'/passwordedit',
            'resetButtonText'         => 'изменить пароль',
            ...
            'showResetButtonText'     => $this->isShowResetButton(),
        ];
    }
